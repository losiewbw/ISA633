...
_The +1 on the Beta parameters come from the fact that an uninformative prior was used to derive the distribution._  A prior distribution in Bayesian statistics is chosen to reflect your current or prior beliefs about how a distribution or statistic will behave.  
