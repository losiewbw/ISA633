...
-   maybe its not training but it is the testing within subjects design

We could have chose to perform a *between-subjects design*. How might that work?

-   20 people in before (control 20 people ==\> course)

-   Instead of controlling for typing ability --\> randomizing over it

What would be the downside of a *between-subjects design* here?

-   Need more n (samples) - have more error
