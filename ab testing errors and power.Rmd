...
The probability of observing those sample statistics is really small.  But they exist.  So when we set a type I error rate we are acknowledging that we _could_ be drawing a sample statistic from those unlikely places in the distribution and we are willing to accept a certain level of risk.
...
One way to focus our attention is by thinking about _effect size_.  
