...
```{R}
df<-read.csv("https://raw.githubusercontent.com/losiewbw/ISA633/main/ab_revenue.csv?token=GHSAT0AAAAAACN4F7RC7I7QH4HIE5XURMCSZOCQKSQ", stringsAsFactors = TRUE)
head(df)
```
...
df = pd.read_csv("I:\\Classes\\ISA 633\\2. AB Testing\\ab testing continuous\\ab_revenue.csv")
